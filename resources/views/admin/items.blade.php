...
<head>
    ...
    <title>Manajemen Barang - NexStock</title>
...
<body class="bg-slate-50 min-h-screen">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-900">Manajemen Barang</h1>
                <p class="text-slate-600 mt-1">Kelola inventaris barang dengan mudah</p>
            </div>
                    ...
                    <form action="/admin" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" required
                                   ...
                                   value="{{ old('name') }}" placeholder="Minimal 5 karakter">
                        </div>
                        ...
                        <div>
                            <label for="photo" class="block text-sm font-medium text-slate-700 mb-2">Photo URL (wajib)</label>
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    @foreach($items as $index => $item)
                                        <tr class="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td class="py-3 px-4">
                                                <div class="flex items-center space-x-2">
                                                    <a href="/admin/items/{{ $item->id }}/edit" class="text-indigo-600 hover:text-indigo-700 transition-colors">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="/admin/items/{{ $item->id }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">
                                                        @csrf
                                                        @method('DELETE')
