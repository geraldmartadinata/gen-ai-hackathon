        ...
        <div class="print-header">
            <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                    <h2 class="text-xl font-bold text-gray-900 mb-1">FAKTUR PEMBELIAN</h2>
                    <p class="text-sm text-gray-600 mb-3">No. {{ $invoiceNumber }}</p>
                    <div class="text-sm text-gray-600">
                        <p><strong>Tanggal:</strong> {{ date('d F Y') }}</p>
                        <p><strong>Pukul:</strong> {{ date('H:i:s') }}</p>
                        <p><strong>Pembeli:</strong> {{ auth()->user()->name }}</p>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="font-medium text-gray-900">{{ $request->shipping_address }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 mb-1">Kode Pos:</p>
                    <p class="font-medium text-gray-900">{{ $request->postal_code }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <div class="text-center py-8 bg-gray-50 rounded-lg">
                    <p class="text-gray-600">Tidak ada data barang dalam faktur</p>
                </div>
            @endif
        </div>
        ...
        <div class="border-t-2 border-gray-800 pt-6 mt-8">
            <div class="grid grid-cols-3 gap-4">
                <div class="text-center">
                    <p class="text-sm text-gray-600 mb-8">Pembeli</p>
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs text-gray-600">Manajer Penjualan</p>
                </div>
                <div class="text-center">
            ...
            <div class="text-center mt-8 pt-4 border-t border-gray-300">
                <p class="text-xs text-gray-500">
                    Faktur ini dicetak secara otomatis dari sistem NexStock pada {{ date('d F Y H:i:s') }}<br>
                    Dokumen ini sah dan dapat digunakan sebagai bukti pembelian.
                </p>
            </div>
        </div>
    </div>
